...
import BG from '../assests/first_bg.png'
        ...
        return (
            <div className=' h-screen'>
                ...
                <div className="absolute h-[100%] w-[100%]">
                    ...
                    <div className="flex justify-center align-middle mt-[103px] w-[800px] h-[125px] ml-[161px] box-border border border-solid border-black
                                     rounded-full  bg-bg-loc_sec"
                    >
                        <div className=" flex flex-col justify-center  align-center px-[1.5rem]">
                            <div className=' px-2'>
                                <SlLocationPin
                                    className=" inline-block text-white text-3xl "
                                ...
                                <h3 className="w-[196px] h-[19px] ml-[46px] md-[50px] font-[Satoshi] underline  underline-offset-[14px] inline p-4 text-[26px] text-white font-medium ">
                                    <input type="text" placeholder='Search for a City' className=' inline-block w-[215px] bg-transparent text-white placeholder:text-white border-b focus:outline-none' />
                                </h3>
        ...
        return (
            <div className="flex flex-col items-center justify-center h-screen bg-gray-100">
                <div className="flex flex-col items-center text-center justify-center">
                    ...
                    <span className=' text-blue-500'>Empowring</span>  Justice, <span className='text-blue-500'>Protecting</span>  Rights
                    </h2>
                    <div className="flex items-center justify-center  space-x-2">
                        <div className="flex items-center gap-8 text-xl h-16 border-2 border-gray-800 rounded-md">
                            ...
                            <h3 className="font-[Satoshi] w-[40%] text-center text-black font-medium ">
                                    <input type="text" placeholder='Search for a City' className=' inline-block w-[215px] bg-transparent border-black focus:outline-none' />
                            </h3>
                        </div>
